...
1. [Avengers: Infinity War Wikipedia page](https://en.wikipedia.org/wiki/Avengers:_Infinity_War)  
2. [Avengers: Infinity War IMDb page](https://www.imdb.com/title/tt4154756/)  
3. [Avengers: Infinity War Rotten Tomatoes page](https://www.rottentomatoes.com/m/avengers_infinity_war)  
4. [Step function documentation](https://www.rdocumentation.org/packages/stats/versions/3.6.1/topics/step)  
