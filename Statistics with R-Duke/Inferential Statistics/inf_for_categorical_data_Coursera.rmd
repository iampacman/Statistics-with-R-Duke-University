...
```{r perc-atheist-us12}
ath_pop_us <- us12%>%
  filter(response == "atheist", year == "2012")
round(count(ath_pop_us)/count(us12),2)
```
...
proportion_us = 0.0499
margin_of_error = qnorm(0.975)*sqrt((proportion_us*(1-proportion_us))/1002)
round(margin_of_error,4)
```
...
inference(y = response, data = ath_pop_ind, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

ath_pop_jap <- atheism %>%
  filter(nationality == "Japan", year == "2012")
inference(y = response, data = ath_pop_jap, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
proportion_spain = sum(spain$response == "atheist")/length(spain$response)
inference(y = spain$response, x = spain$year, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist", data = spain)
inference(y = spain$response, x = spain$year, statistic = "proportion", type = "ht", method = "theoretical", success = "atheist", data = spain, alternative = "less", null =0)
...
```{r us-05-12}
united_states = subset(atheism, atheism$nationality == "United States")
proportion_spain = sum(spain$response == "atheist")/length(spain$response)
inference(y = united_states$response, x = united_states$year, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist", data = united_states)
inference(y = united_states$response, x = united_states$year, statistic = "proportion", type = "ht", method = "theoretical", success = "atheist", data = united_states, alternative = "less", null = 0)
